...
console.log(arr3)
//여러분이 설계한 구조에서 필요한 길이만큼 생성해야하는 배열이 있을 때 사용


//Array().fill().map()
// 함수 표현식의 {} 과 객체 표현식의 {}의 겹침으로서  return  생략이 불가
// 이럴 경우 함수 표현식 부분의 {}를 ()로 바꿔주면 return이 생략이 가능
...
// + early return에서도 return은 탈출문이기 떄문에 생략하면 안됨, {}는 생략 가능
